      ...
      <ErrorBoundary>
        ...
        {backendStatus === 'offline' && (
          <div className="fixed inset-0 z-[200] bg-white dark:bg-gray-900 flex flex-col items-center justify-center gap-4 px-8">
            ...
            <h2 className="text-lg font-semibold text-[#111827] dark:text-gray-100">Cannot connect to server</h2>
            <p className="text-sm text-[#6B7280] dark:text-gray-400 text-center max-w-sm">Please check your connection and try again.</p>
            ...
            <Route path="/about" element={
              <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div className="text-center">
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">About</h1>
                  <p className="text-gray-600 dark:text-gray-400">AICodeTutor — University project</p>
                </div>
              </div>
            } />
