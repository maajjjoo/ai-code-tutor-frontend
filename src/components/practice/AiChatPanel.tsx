    ...
    <>
      <div className="h-[44px] border-b border-[#E5E7EB] flex items-center px-[14px] shrink-0">
        ...
        <div className="flex items-center gap-[8px]">
          ...
          <button onClick={onAnalyze} disabled={!code.trim()} className="flex items-center gap-1 bg-[#534AB7] text-white rounded-[8px] px-[12px] py-[5px] text-[12px] font-medium cursor-pointer hover:opacity-90 border-none disabled:opacity-40 disabled:cursor-not-allowed">
        ...
        <>
          <div className="px-3 pb-2 pt-1">
            <div className="flex flex-wrap gap-[6px] mb-[10px]">
              <button onClick={() => onInputChange('What should I do next?')} className="bg-[#EEEDFE] text-[#3C3489] border border-[#AFA9EC] rounded-full px-[12px] py-[4px] text-[11px] font-medium cursor-pointer hover:bg-[#CECBF6] transition-colors">
                Next step?
              </button>
              <button onClick={() => onInputChange('Explain what my code does')} className="bg-[#EEEDFE] text-[#3C3489] border border-[#AFA9EC] rounded-full px-[12px] py-[4px] text-[11px] font-medium cursor-pointer hover:bg-[#CECBF6] transition-colors">
                Explain this
              </button>
            </div>
          </div>
