  ...
  if (isCollapsed) {
    return (
      <div className="h-8 bg-[#EEEDFE] border-b border-[#AFA9EC] flex items-center gap-2 px-5 shrink-0">
        ...
        <span className="text-[12px] text-[#3C3489] truncate max-w-xs flex-1">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[13px] font-medium text-[#3C3489] truncate ml-2">
              {context.lessonTitle}
            </span>
          </div>
          <p className="text-[12px] text-[#4B5563] mt-1 max-w-[70%] line-clamp-2">
